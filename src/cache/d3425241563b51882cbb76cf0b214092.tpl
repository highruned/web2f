...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		<title>Stoke Games | Privacy Policy</title>
		...
		<link type="application/rss+xml" rel="alternate" title="Stoke Games | Privacy Policy - RSS" href="http://www.stokegames.com/privacy/?rss=1">
		<link type="text/css" rel="stylesheet" href="http://www.stokegames.com/css/main.css" media="screen" />
		<link type="text/css" rel="stylesheet" href="http://www.stokegames.com/css/jTooltips.css" media="screen" />
		<link type="text/css" rel="stylesheet" href="http://www.stokegames.com/themes/stoke/css/main.css" media="screen" />
		<link type="text/css" rel="stylesheet" href="http://www.stokegames.com/themes/stoke/css/colors.css" media="screen" />
		
		<script type="text/javascript" src="http://www.stokegames.com/js/jquery.js"></script>
		<script type="text/javascript" src="http://www.stokegames.com/js/jquery.jTooltips.js"></script>
		<script type="text/javascript" src="http://www.stokegames.com/js/cms.js"></script>
		...
		<script type="text/javascript" src="http://www.stokegames.com/themes/stoke/js/main.js"></script>
	</head>
	<body>
		<div class="top clear">
			<div class="header">
...
<p><b>15. Miscellaneous information</b><br />(i) In the event that any provision of these Terms of use is deemed to conflict with legislation by a court with jurisdiction over the parties, the said provision will be interpreted to reflect the original intentions of the parties in accordance with applicable law, and the remainder of these Terms of use will remain valid and applicable; (ii) The failure of either party to assert any right under these Terms of use will not be considered to be a waiver of that party's right, and the said right will remain in full force and effect; (iii) You agree that any claim or cause in respect of this web site or its services must be filed within one (1) year after such claim or cause arose, or the said claim or cause will be forever barred, without regard to any contrary legislation; (iv) The site editor may assign the site editor's rights and obligations under these Terms of use; in this event, the site editor will be relieved of any further obligation.</p>						</div>
						<div class="footer clear">
							...
							<div class="menu">
								...
								<div>
									<a href="http://www.stokegames.com/privacy/?rss=1">
