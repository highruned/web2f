...
define('API_USERNAME', $settings['paypal_api_username']);
...
define('API_PASSWORD', $settings['paypal_api_password']);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $settings['paypal_api_signature']);
...
if($settings['paypal_api_sandbox'])
	...
	define('API_ENDPOINT', 'https://api-aa-3t.paypal.com/nvp');
